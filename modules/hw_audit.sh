...
# ── Main collector ────────────────────────────────────────────────────────────────
collect_hardware() {
    echo -e "    ${DIM}→ CPU...${RESET}"     && collect_cpu
    echo -e "    ${DIM}→ GPU...${RESET}"     && collect_gpu
    echo -e "    ${DIM}→ RAM...${RESET}"     && collect_ram
    echo -e "    ${DIM}→ Disk...${RESET}"    && collect_disk
    echo -e "    ${DIM}→ Network...${RESET}" && collect_network
    echo -e "    ${DIM}→ Board...${RESET}"   && collect_motherboard
    echo -e "    ${DIM}→ USB...${RESET}"     && collect_usb
    echo -e "    ${DIM}→ Battery...${RESET}" && collect_battery
